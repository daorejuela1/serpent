function [result] = invert_boxes (binary_input,numero)
% INVERT_BOXES - reads the boxes from the sheet to obtain each value
%   Inputs:
...
%   number
x = vtoh(binary_input);
[~,~,cajas] = xlsread('serpent_boxes/invert_boxes.xlsx');
